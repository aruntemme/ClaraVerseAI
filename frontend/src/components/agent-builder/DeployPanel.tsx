...
import { generateDeploymentCode, type Language } from '@/services/deployCodeGenerator';
...
export function DeployPanel({ isOpen, onClose }: DeployPanelProps) {
  ...
  const generatedCode = generateDeploymentCode({
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                          <p className="text-sm font-medium text-white">More Triggers</p>
                          <p className="text-xs text-white/40">Webhooks, Gmail, Sheets, and more</p>
                        </div>
                      </div>
                      <ChevronRight
                        size={18}
                        className={cn(
                          'text-white/30 transition-transform',
                          expandedSection === 'webhook' && 'rotate-90'
                        )}
                      />
                    </button>
                        ...
                        >
                          <div className="space-y-4 pl-3">
                            <div className="p-4 rounded-xl bg-white/5 text-center">
                              ...
                              <p className="text-xs text-white/40">
                                Webhooks, Gmail, Google Sheets, and other event-based triggers
                              </p>
                            </div>
                          </div>
                        </motion.div>
