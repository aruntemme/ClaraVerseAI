...
export const ProviderForm: React.FC<ProviderFormProps> = ({
  ...
  const handleSpecialTypeChange = (type: 'audio_only' | 'image_only' | 'image_edit_only', checked: boolean) => {
    setFormData(prev => ({
      ...prev,
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="base_url" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1">
              API Base URL *
            </label>
            <input
              type="text"
              ...
              disabled={isSubmitting}
            />
            {errors.base_url && <p className="text-xs text-[var(--color-error)] mt-1">{errors.base_url}</p>}
          </div>

          <div>
            <label htmlFor="api_key" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1">
              API Key *
            </label>
            ...
            {errors.api_key && <p className="text-xs text-[var(--color-error)] mt-1">{errors.api_key}</p>}
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <label className="flex items-center gap-3 p-3 bg-[var(--color-surface)] rounded-lg hover:bg-[var(--color-surface-hover)] transition-colors cursor-pointer">
              ...
              />
              <div>
                <div className="text-sm font-medium text-[var(--color-text-primary)]">Audio Only (Transcription)</div>
            ...
            <label className="flex items-center gap-3 p-3 bg-[var(--color-surface)] rounded-lg hover:bg-[var(--color-surface-hover)] transition-colors cursor-pointer">
              ...
              />
              <div>
                <div className="text-sm font-medium text-[var(--color-text-primary)]">Image Editing</div>
                <div className="text-xs text-[var(--color-text-tertiary)]">
          ...
          {errors.special_type && <p className="text-xs text-[var(--color-error)] mt-1">{errors.special_type}</p>}
        </div>
        ...
        <div className="space-y-3">
          ...
          <label className="flex items-center gap-3 p-3 bg-[var(--color-surface)] rounded-lg hover:bg-[var(--color-surface-hover)] transition-colors cursor-pointer">
            ...
            />
            <div>
              <div className="text-sm font-medium text-[var(--color-text-primary)]">Private/Secure Provider</div>
              <div className="text-xs text-[var(--color-text-tertiary)]">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="default_model" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1">
              Default Model
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="favicon" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1">
              Favicon URL
            </label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="system_prompt" className="block text-sm font-medium text-[var(--color-text-primary)] mb-1">
              System Prompt
            </label>
            <textarea
              id="system_prompt"
